...
(function() {
	...
	var ad = void 0,
		bd = function(a) {
			return ad ? ad : (a ? "https:" : Ba || "https:" == M.location.protocol ? "https:" : "http:") +
		...
		ge = function(a, b, c) {
			1 <=
				100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j76", "sr=1"], b && a.push("_f=" + b), c && a.push(
					"_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(ad ? ad + "/33" : bd(!0) + "/u/d", a.join(
					"&"), ua))
		};
	var h = function(a) {
	...
	var u = function(a, b, c) {
		...
		y = function(a, b, c, d, e) {
			if (!ea(Yd.get(b)) && !$d.get(b)) {
				...
				if (c && (c && 0 <= c.indexOf("/") || (c = (ad ? ad + "/34" : bd(!1) + "/plugins/ua/") + c), d = ae(c), a = d.protocol,
						c = M.location.protocol, ("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(d))) {
					if (d =
						d.url) a = (a = M.querySelector && M.querySelector("script[nonce]") || null) ? a.nonce || a.getAttribute && a.getAttribute(
						"nonce") || "" : "", e ? (e = "", a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(d) && M.write("<script" +
						e + ' src="' + d + '">\x3c/script>')) : (e = M.createElement("script"), e.type = "text/javascript", e.async = !
						0, e.src = d, a && e.setAttribute("nonce", a), d = M.getElementsByTagName("script")[0], d.parentNode.insertBefore(
							e, d));
					$d.set(b, !0)
				}
			}
